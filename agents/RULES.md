...
- **iOS companion** lives under [`companion/iOS/`](../companion/iOS/) (Xcode project **Juxta6**). Do not west-build it; do not mix NCS/west commands into that tree. Keep firmware (`applications/`, `lib/`) and companion edits in lockstep on the Hublink / schema v7 contract (`companion/iOS/spec_HUBLINK.md`).
